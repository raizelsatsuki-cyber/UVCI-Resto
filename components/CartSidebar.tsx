...
export const CartSidebar: React.FC<CartSidebarProps> = ({ onClose }) => {
  const { cartItems, updateQuantity, removeFromCart, totalAmount, cartCount, paymentMethod, setPaymentMethod, placeOrder } = useCart();
  const { user } = useAuth();
        ...
        {status === 'success' && (
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8 gap-4">
            <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center">
              <CheckCircle size={48} className="text-uvci-green" />
            </div>
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-uvci-purple text-white font-bold rounded-xl text-sm hover:bg-uvci-purple/90 transition"
            >
          ...
          <>
                ...
                return (
                  <div key={item.id} className="bg-gray-50 rounded-xl p-3 border border-gray-100 flex gap-3">
                    ...
                    <div className="flex flex-col items-center justify-between">
                      <button onClick={() => removeFromCart(item.id)} className="text-gray-300 hover:text-red-400 transition"><X size={14} /></button>
            ...
            <div className="p-4 border-t border-gray-100 space-y-3 bg-white">
              ...
              <div className="relative">
                ...
                <input type="tel" placeholder="N° téléphone (ex: 0707070707)"
              ...
              <button onClick={handleCheckout} disabled={!isValid || status === 'processing'}
